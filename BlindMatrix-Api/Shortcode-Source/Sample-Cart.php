					...
					<div class="box has-hover   has-hover box-shadow-1 box-bounce box-text-bottom">
						<div class="box-image">
							<div class="image-cover" style="padding-top:100%;">
								<a href="<?php bloginfo('url'); ?>/<?php echo($productview_page); ?>/<?php echo str_replace(' ','-',strtolower($_SESSION['cart'][$key]['productname'])); ?>/<?php echo str_replace(' ','-',strtolower($_SESSION['cart'][$key]['colorname'])); ?>/">
						...
						<div class="box-text text-center">
							<div class="box-text-inner">
								...
								<p><a href="javascript:;" tile="Remove this item" class="button alert" onClick="removeitem(<?php echo $key; ?>);"><span>Remove</span></a></p>
							</div><!-- box-text-inner -->
						</div><!-- box-text -->
					</div><!-- .box  -->
				</div>
