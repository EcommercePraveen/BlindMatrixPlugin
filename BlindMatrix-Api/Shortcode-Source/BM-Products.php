...
<div class="row row-small align-center row-box-shadow-2 row-box-shadow-4-hover" id="row-1778499989">
    <?php $pro =1;?>
			...
			<div class="box cusbox has-hover has-hover box-default box-text-bottom">
				...
				<div class="box-text text-center">
					...
					<div class="social-icons follow-icons">
						<a href="<?php bloginfo('url'); ?>/<?php echo($product_page); ?>/<?php echo str_replace(' ','-',strtolower($get_productname)); ?>" class="button primary is-outline box-shadow-2 box-shadow-2-hover">
