			...
			<div class="box-image">
			   ...
			   <div class="price-lozenge">
					<div class="price-lozenge__inner">
						...
						<div class="amount">
							<span data-price-incl-discount="£15" class="price-lozenge__price"><?php echo $_SESSION['currencysymbol'];?><?php echo $ShutterProductTypeList->price; ?></span>
