...
<div class="col medium-12 large-12">
    <div class="row content-row mb-10 ">
        <div class="product-gallery col large-8" style="margin: auto;">
                   ...
                   <tbody>
					  ...
					  <tr>
                	    ...
                	    <tr id="bm_product">
                         <td class="label">
                            ...
                            <img class="lbl-icon" src="http://blindssoftware.com/Ecom-live/wp-content/themes/blindsshop/icon/right-arrow.gif">
                    ...
                    <tr class="colour_category_container blindsdiv" >
                         <td class="label">
                            <label class="label_table_quotes" for="Colour">
                            <img class="lbl-icon" src="http://blindssoftware.com/Ecom-live/wp-content/themes/blindsshop/icon/right-arrow.gif">
                            Colour/Material <font color="red">*</font>
                            </label>
                         </td>
						 <td class="value">
...
function getcolorcategories(){
    ...
    jQuery.ajax(
	{
		...
		data    : {mode:'get_quick_quote_colorcategories',productcode:productcode,blindstype:blindstype},
		type    : "POST",
		dataType: 'JSON',
		success: function(response){
			...
			function formatState (opt) {
				...
				var optimage = jQuery(opt.element).attr('data-image'); 
					...
					var $opt = jQuery(
					   '<span style="font-size: 10px;"><img style="margin-right:8px;" src="' + optimage + '" width="25px" /> ' + opt.text + '</span>'
					);
					return $opt;
    			}
            }
