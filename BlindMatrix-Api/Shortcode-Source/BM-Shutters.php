			...
			<div class="box cusbox has-hover has-hover box-default box-text-bottom">
				...
				<div class="box-text text-center">
					...
					<div class="social-icons follow-icons">
						<a href="<?php bloginfo('url'); ?>/<?php echo($shutters_page); ?>/<?php echo trim(strtolower($url_productTypeSubName));?>/<?php echo $GetShutterProductTypeList->parameterTypeId; ?>" class="button primary is-outline box-shadow-2 box-shadow-2-hover">
