...
class OrderDetails_List extends WP_List_Table {
	...
	public static function get_customers( $per_page = 5, $page_number = 1 ) {
		...
		$json_response = CallAPI("POST", $post=array("mode"=>"get_bm_order_details","per_page"=>$per_page,"page_number"=>$page_number,"orderby"=>$_REQUEST['orderby'],"sort"=>$_REQUEST['order']));
